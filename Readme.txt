...
В коде используются два глобальных обьекта - $smarty и $db - обьекты смарти и DbSimple - подключение к базе происходит только при необходимости, также есть встроенное кеширование (местами, частично прикрученное :).
