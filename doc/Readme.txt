...
Добавил константу MODPATH

Прикрутил подсветку PlainPHP к кейту, пока упрощенный синтаксис хедеров только для JS (sJS и eJS)
класть в /usr/share/apps/katepart/syntax
