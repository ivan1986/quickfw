...
8) Переписать интерфейс подключения модуля - сейчас завязан на интерфейс смарти
сделано
...
def ext - для СЕОнистов (кто это такие - к Валере ;) (нифига. К Диме Смирнову ;-) (вобщем - что это такое - к Диме Смирнову, кто это такой - к Валере :-P)
